...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('account_userprofile', (
            ('id', orm['account.UserProfile:id']),
            ('created_on', orm['account.UserProfile:created_on']),
            ('updated_on', orm['account.UserProfile:updated_on']),
            ('user', orm['account.UserProfile:user']),
            ('twitter_access_token', orm['account.UserProfile:twitter_access_token']),
        ))
