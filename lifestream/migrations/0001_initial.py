...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('lifestream_twitterstatus', (
            ('id', orm['lifestream.TwitterStatus:id']),
            ('created_on', orm['lifestream.TwitterStatus:created_on']),
            ('updated_on', orm['lifestream.TwitterStatus:updated_on']),
            ...
            ('breakout_session', orm['lifestream.TwitterStatus:breakout_session']),
        ))
    ...
    models = {
        ...
        'lifestream.twitterstatus': {
            'breakout_session': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'twitter_statuses'", 'to': "orm['breakout.BreakoutSession']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
